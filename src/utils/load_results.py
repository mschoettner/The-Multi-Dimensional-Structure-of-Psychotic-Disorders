...
def load_robustness_loadings(path, method, n_components, iterations, rotation=None):
    """
    ...
    if rotation:
        folder = f"{method}_{n_components}-components_{iterations}-iterations_rotation-{rotation}"
